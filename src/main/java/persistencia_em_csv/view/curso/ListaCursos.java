...
import persistencia_em_csv.view.curso.FormularioCurso;
...
public class ListaCursos extends javax.swing.JPanel {
    ...
    private CursoDAO dao = CursoDAO.getInstancia();
    ...
    public ListaCursos() {
        ...
        new SwingWorker<List<Curso>, Void>() {
            @Override
            protected List<Curso> doInBackground() throws Exception {
                try {
                    cursos = dao.ler(barraProgresso);
                    atualizarTabela();
                } catch (Exception ex) {
                    ex.printStackTrace();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int resposta = JOptionPane.showConfirmDialog(
            this, "Tem certeza de que deseja excluír o curso " + curso.getNome() + "?", 
        ...
        new SwingWorker<List<Curso>, Void>() {
            ...
            protected List<Curso> doInBackground() throws Exception {
                try {
                    ...
                    //cursos = dao.buscar(filtro, barraProgresso);
                    atualizarTabela();
                } catch (Exception e) {
                    e.printStackTrace();
